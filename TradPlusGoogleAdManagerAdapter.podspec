Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusGoogleAdManagerAdapter/TradPlusGoogleAdManagerAdapter-8.0.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusGoogleAdManagerAdapter-8.0.0/GoogleAdManagerAdapter.framework'
end
