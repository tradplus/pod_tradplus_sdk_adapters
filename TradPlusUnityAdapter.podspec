Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusUnityAdapter/TradPlusUnityAdapter-1.0.1.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusUnityAdapter-1.0.1/UnityAdapter.framework'
end
