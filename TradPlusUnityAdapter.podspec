Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusUnityAdapter/TradPlusUnityAdapter-8.4.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusUnityAdapter-8.4.0/UnityAdapter.framework'
end
