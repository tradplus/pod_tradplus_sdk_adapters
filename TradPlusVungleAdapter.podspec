Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusVungleAdapter/TradPlusVungleAdapter-8.5.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusVungleAdapter-8.5.0/VungleAdapter.framework'
end
