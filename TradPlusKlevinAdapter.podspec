Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusKlevinAdapter/TradPlusKlevinAdapter-8.3.20.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusKlevinAdapter-8.3.20/KlevinAdapter.framework'
end
