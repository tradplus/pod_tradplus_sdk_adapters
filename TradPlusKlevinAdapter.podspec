Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusKlevinAdapter/TradPlusKlevinAdapter-8.6.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusKlevinAdapter-8.6.0/KlevinAdapter.framework'
end
