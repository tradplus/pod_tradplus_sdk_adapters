Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusGDTMobAdapter/TradPlusGDTMobAdapter-8.0.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusGDTMobAdapter-8.0.0/GDTMobAdapter.framework'
end
