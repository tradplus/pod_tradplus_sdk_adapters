Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusKuaiShouAdapter/TradPlusKuaiShouAdapter-8.6.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusKuaiShouAdapter-8.6.0/KuaiShouAdapter.framework'
end
