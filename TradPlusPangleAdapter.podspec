Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusPangleAdapter/TradPlusPangleAdapter-8.3.20.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusPangleAdapter-8.3.20/PangleAdapter.framework'
end
