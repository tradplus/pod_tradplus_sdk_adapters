Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusOguryAdapter/TradPlusOguryAdapter-8.1.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusOguryAdapter-8.1.0/OguryAdapter.framework'
end
