Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusStartAppAdapter/TradPlusStartAppAdapter-8.3.20.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusStartAppAdapter-8.3.20/StartAppAdapter.framework'
end
