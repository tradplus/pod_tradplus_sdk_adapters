Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusTPCrossAdapter/TradPlusTPCrossAdapter-8.2.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusTPCrossAdapter-8.2.0/TPCrossAdapter.framework'
end
