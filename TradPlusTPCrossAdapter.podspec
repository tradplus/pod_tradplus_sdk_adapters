Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusTPCrossAdapter/TradPlusTPCrossAdapter-11.6.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusTPCrossAdapter-11.6.0/TPCrossAdapter.framework'
end
