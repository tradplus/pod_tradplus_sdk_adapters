Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusAdMobAdapter/TradPlusAdMobAdapter-8.2.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusAdMobAdapter-8.2.0/AdMobAdapter.framework'
end
