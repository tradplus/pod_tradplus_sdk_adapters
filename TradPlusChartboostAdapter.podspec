Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusChartboostAdapter/TradPlusChartboostAdapter-8.0.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusChartboostAdapter-8.0.0/ChartboostAdapter.framework'
end
