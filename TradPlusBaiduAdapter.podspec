Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusBaiduAdapter/TradPlusBaiduAdapter-8.2.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusBaiduAdapter-8.2.0/BaiduAdapter.framework'
end
