Pod::Spec.new do |spec|
 	...
 	spec.source = { :http => 'https://github.com/tradplus/pod_tradplus_sdk_adapters/raw/main/TradPlusMaioAdapter/TradPlusMaioAdapter-8.2.0.zip', :type => 'zip' }
 	...
 	spec.vendored_frameworks = 'TradPlusMaioAdapter-8.2.0/MaioAdapter.framework'
end
